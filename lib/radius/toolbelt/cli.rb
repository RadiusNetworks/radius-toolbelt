  ...
  module Toolbelt
    class CLI
      ...
      command :release do |c|
        ...
        c.option '--add FILES',
          Array,
          'List of files/globs to add to repo prior to release.' do |f|
            cli_opts.add_files.concat f
          end
        c.option '--remove FILES',
          Array,
          'List of files/globs to remove from repo prior to release.' do |f|
            cli_opts.remove_files.concat f
          end
        c.option '--binary FILES',
          Array,
          'Binary file(s) to attach to the release.' do |files|
